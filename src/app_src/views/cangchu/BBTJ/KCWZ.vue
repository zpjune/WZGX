  ...
  <div class="topSearh" id="topsearch">
    ...
    <el-card class="box-card">
      <el-table
        ...
        style="width: 100%"
      >
             <el-table-column  fixed="left" align="center" label="大类">
          <template slot-scope="scope">
            <span>{{scope.row.MATKL}}</span>
          </template>
        </el-table-column>
       ...
       <el-table-column  align="center" label="实存">
          <template slot-scope="scope">
            <span>{{scope.row.GESME |NumFormat}}</span>
          </template>
        </el-table-column>
         <el-table-column  align="center" label="虚存">
          <template slot-scope="scope">
            <span>{{scope.row.GESME |NumFormat}}</span>
          </template>
        </el-table-column>
         <el-table-column  align="center" label="小计(实存+虚存)">
          <template slot-scope="scope">
            <span>{{scope.row.HJ |NumFormat}}</span>
          </template>
        </el-table-column>
         <el-table-column  align="center" label="本年度入库库存">
          <template slot-scope="scope">
            <span>{{scope.row.GESME |NumFormat}}</span>
          </template>
        </el-table-column>
