<template>
  <div id="detailZDWZNEW" class="app-container calendar-list-container">
...
<script>
import { getDetailZDWZCBTOTAL,getDetailZDWZCBTOTALDETAIL } from "@/app_src/api/cangchu/KCZS/ZXK";
export default {
  name: "detailZDWZNEW",
   filters:{
