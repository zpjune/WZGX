    ...
    <el-row>
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        ...
        >
          ...
          <el-table-column label="物料描述" prop="MAKTX" :show-overflow-tooltip="true" width="550"></el-table-column>
          <el-table-column label="计量单位" prop="MEINS"></el-table-column>
          <el-table-column label="实存数量" prop="GESME"></el-table-column>
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="btnDetail(scope.row)">明细</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
<script>
import {
  getDetailZDWZCBTOTAL,
  getDetailZDWZCBTOTALDETAIL
...
export default {
  ...
  methods: {
    ...
    getQueryValue(data) {
      ...
      this.listQuery.MAKTX = data.MAKTX;
      this.getList();
    },
    getList() {
      this.listQuery.DKCODE = this.DKCODE;
      getDetailZDWZCBTOTAL(this.listQuery).then(res => {
    ...
    getListDetail() {
      ...
      getDetailZDWZCBTOTALDETAIL(this.listQueryDetail).then(res => {
        if (res.data.code === 2000) {
