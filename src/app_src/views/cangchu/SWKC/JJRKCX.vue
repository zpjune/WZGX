<template>
  <div id="JJRKCX" class="app-container calendar-list-container">
    ...
    <el-row>
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        ...
        >
          ...
          <el-table-column label="入库原因" prop="NAME" width="230px"></el-table-column>
    ...
    <el-dialog :visible.sync="show" :title="title" width="70%">
      <el-card>
        <el-form :model="temp" :rules="rules" label-width="120px" ref="dataform">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="实际入库数量" prop="RKNUMBER1">
...
export default {
  ...
  methods: {
    ...
    send(data) {
      this.$confirm("您确定提交次入库单吗?本操作不可撤销!", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(() => {
