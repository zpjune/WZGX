...
<script>
import clip from '@/frame_src/utils/clipboard' // use clipboard directly
import clipboard from '@/frame_src/directive/clipboard/index.js' // use clipboard by v-directive
