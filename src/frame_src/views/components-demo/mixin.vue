...
<script>
import PanThumb from '@/frame_src/components/PanThumb'
import MdInput from '@/frame_src/components/MDinput'
import Mallki from '@/frame_src/components/TextHoverEffect/Mallki'
import DropdownMenu from '@/frame_src/components/Share/dropdownMenu'
import waves from '@/frame_src/directive/waves/index.js' // 水波纹指令
