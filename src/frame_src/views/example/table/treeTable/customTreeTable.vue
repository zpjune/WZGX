<template>
  <div class="app-container">
    ...
    <el-tag style="margin-bottom:20px;">
      <a href="https://github.com/zhangfan6385/Dgyt_test1/tree/master/src/components/TreeTable" target="_blank">Documentation</a>
    </el-tag>
...
*/
import treeTable from '@/frame_src/components/TreeTable'
