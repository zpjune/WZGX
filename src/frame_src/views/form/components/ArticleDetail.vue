...
<script>
import Tinymce from '@/frame_src/components/Tinymce'
import Upload from '@/frame_src/components/Upload/singleImage3'
import MDinput from '@/frame_src/components/MDinput'
import Multiselect from 'vue-multiselect'// 使用的一个多选框组件，element-ui的select不能满足所有需求
import 'vue-multiselect/dist/vue-multiselect.min.css'// 多选框组件css
import Sticky from '@/frame_src/components/Sticky' // 粘性header组件
import { validateURL } from '@/frame_src/utils/validate'
import { fetchArticle } from '@/frame_src/api/article'
import { userSearch } from '@/frame_src/api/remoteSearch'
