      ...
      <el-row slot="body" :gutter="24" style="margin-bottom: 20px;">
        ...
        <el-col :span="18" :xs="24" :sm="24" :md="18" :lg="18">
          <el-card class="box-card">
            <div class="text item">
              <el-form :rules="rules" :model="form" ref="form"  :label-width="formLabelWidth">
              ...
              <el-col :span="12" :xs="24" :sm="24" :md="9" :lg="9" :xl="9">
                ...
                <el-form-item label="单位编码">
                  <el-input v-model="form.DW_CODE"></el-input>
                </el-form-item>
                <!-- <el-col :span="12" :xs="24" :sm="24" :md="9" :lg="9" :xl="9">-->
                <el-form-item label :label-width="formLabelWidth">
                  <el-button
                    v-if="form.id==null&&!Useorg"
                    type="primary"
                    @click="onOkSubmit"
                  >{{$t('orgTable.add')}}</el-button>
                  <el-button
                    v-if="form.id!=null&&!Useorg"
                    type="primary"
                    @click="onUpdateSubmit"
                  >{{$t('orgTable.edit')}}</el-button>
                  <el-button
                    type="danger"
                    @click="deleteSelected"
                    v-show="form.orgCode && form.orgCode!=null&&!Useorg"
                  >{{$t('orgTable.delete')}}</el-button>
                </el-form-item>
              </el-form>
            </div>
          </el-card>
